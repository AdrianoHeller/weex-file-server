  ...
  (req: IncomingMessage, res: ServerResponse) => {
    ...
    switch (query.file) {
      case undefined:
        ...
        res.end(
          "nomeCompleto,email,password,dataNascimento,empresa,cargo,endereco,numero,complemento,cep,bairro,cidade,estado,sexo,saldo,isAdmin"
        );
        break;
      default:
      case undefined:
        ...
        const fileData = fs.readFileSync(
          join(__dirname, `../files/${query.file}`)
        );
        if (fileData) {
